...
public interface EventFilter extends Serializable {
     ...
     */
    boolean accept(Event event, EventLogContext context);
    ...
    /**
     * Creates a filter that accepts events from a specific agent.
     *
     * @param agentName The name of the agent
     * @return An EventFilter that accepts events from the specified agent
     */
    static EventFilter byAgent(String agentName) {
        return (event, context) -> agentName.equals(context.getAgentName());
    }

    /**
     * Creates a filter that accepts events from a specific action.
     *
     * @param actionName The name of the action
     * @return An EventFilter that accepts events from the specified action
     */
    static EventFilter byAction(String actionName) {
        return (event, context) -> actionName.equals(context.getActionName());
    }
     ...
     * @return A new EventFilter that accepts events only if both filters accept them
     */
    default EventFilter and(EventFilter other) {
        return (event, context) -> this.accept(event, context) && other.accept(event, context);
    }
     ...
     *
     * @param other The other filter to combine with
     * @return A new EventFilter that accepts events if either filter accepts them
     */
     ...
     *
     * @return A new EventFilter that accepts events this filter rejects and vice versa
     */
    default EventFilter negate() {
        return (event, context) -> !this.accept(event, context);
    }
